        ...
        <div class="response-list-item-content">
          <div>
            ...
            <div class="response-list-item-value">
              ...
              <span class="yellow">
                ${response.ui_final_dmg.toLocaleString('pt')}
              </span>
            </div>
            ...
            <div class="response-list-item-value">
              ...
              <span class="yellow">
                ${response.ui_corrected_final_dmg.toLocaleString('pt')}
              </span>
            </div>
            ...
            <div class="response-list-item-value">
              ...
              <span class="yellow">
                ${response.avgCritDmg.toLocaleString('pt')}
              </span>
            </div>
          ...
          <div class="response-list-item-value">
            ...
            <div class="response-list-item-value">
              ...
              <span class="yellow">
                ${response.ui_back_normal.toLocaleString('pt')}
              </span>
            </div>
            ...
            <div class="response-list-item-value">
              ...
              <span class="yellow">
                ${response.ui_back_critical.toLocaleString('pt')}
              </span>
            </div>
            ...
            <div class="response-list-item-value">
              ...
              <span class="yellow">
                ${response.ui_back_average.toLocaleString('pt')}
              </span>
            </div>
