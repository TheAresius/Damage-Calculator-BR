...
const stringsHistoryListAttack = "Ataque";
const stringsHistoryListSpecialAttack = "Ataque especial";
const stringHistoryListCriticalRate = "Chance de crítico";
const stringHistoryListCriticalDamage = "Dano crítico";
const stringsHistoryListHarrierDebuff = "Debuff Contaminação";
const stringsHistoryListHarrierResistance = "Resist. Contaminação";
const stringsHistoryListASD = "Dano de todas as habilidades";
const stringsHistoryListPola = "Dano ao atacar / ser atacado";
const stringsHistoryListBossDmg = "Dano causado a chefes";
...
const stringsDefNormal = "Hit normal com quebra de defesa";
const stringsDefCritical = "Hit crítico com Quebra de defesa";
const stringsDefAvg = "Dano médio com quebra de defesa";

const stringsDefBackNormal = "Hit normal com quebra de defesa";
const stringsDefBackCritical = "Hit crítico com quebra de defesa";
const stringsDefBackAvg = "Dano médio com quebra de defesa";