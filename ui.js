    ...
    const frontContent = `
        <div class="result-card">
            <div class="result-header header-front">
                <i class="fas fa-gavel"></i> Dano de Frente
            </div>
            
            <div class="result-row">
                <span class="result-label">${stringsNormalHitDamage}</span>
                <span class="result-value val-yellow">${ui_final_dmg.toLocaleString('pt-BR')}</span>
            </div>
            
            <div class="result-row">
                <span class="result-label">${stringsCriticalHitDamage}</span>
                <span class="result-value val-yellow">${ui_corrected_final_dmg.toLocaleString('pt-BR')}</span>
            </div>
            
            <div class="result-row">
                <span class="result-label">${stringsAverageDamage}</span>
                <span class="result-value val-yellow">${avgCritDmg.toLocaleString('pt-BR')}</span>
            </div>
        </div>
    `;
    ...
    const backContent = `
        <div class="result-card">
            <div class="result-header header-back">
                <i class="fas fa-shield-alt"></i> Dano de Costas
            </div>
            
            <div class="result-row">
                <span class="result-label">${stringsBackNormal || "Normal"}</span>
                <span class="result-value val-yellow">${ui_back_normal.toLocaleString('pt-BR')}</span>
            </div>
            
            <div class="result-row">
                <span class="result-label">${stringsBackCritical || "Crítico"}</span>
                <span class="result-value val-yellow">${ui_back_critical.toLocaleString('pt-BR')}</span>
            </div>
            
            <div class="result-row">
                <span class="result-label">${stringsBackAverage || "Médio"}</span>
                <span class="result-value val-yellow">${ui_back_average.toLocaleString('pt-BR')}</span>
            </div>
        </div>
    `;
