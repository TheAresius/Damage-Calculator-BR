    ...
    showInfoButton.addEventListener('click', function(event) {
        ...
        modalText.innerHTML = `
            ...
            <div class="modal-body">
                <div class="modal-section"><div class='modal-subtitle'>[Descrição]</div><div class="modal-text">${enemyInfo.description}</div></div>
                <div class="modal-section"><div class='modal-subtitle'>[Status e Defesas]</div>
                ...
                <div class="modal-section"><div class='modal-subtitle'>[Mecânicas e Extras]</div><div class="extra-content">${formattedExtras}</div></div>
            </div>
